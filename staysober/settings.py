"""
Django settings for staysober project.
...
SECRET_KEY = 'django-insecure-utzrv!=zm02xk#e3eogk=mnpki^6%*7^osqixqp)a*ikipdpaf'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['staysober.onrender.com']
# ALLOWED_HOSTS=[]
...
WSGI_APPLICATION = 'staysober.wsgi.application'
